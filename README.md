...
Este repositorio es una introducción bilingüe (español e inglés) al Imperio Inca,
una de las civilizaciones más importantes de los Andes antes de la llegada de los europeos.

This repository is a bilingual (Spanish & English) introduction to the Inca Empire,
one of the most important Andean civilizations before the arrival of Europeans.
...
- Presentar de forma clara y accesible la historia del Imperio Inca.
- Ofrecer contenido en español e inglés para estudiantes y curiosos.
- Servir como base para recursos educativos, presentaciones y proyectos personales.

**EN**

- Provide a clear and accessible overview of the Inca Empire.
- Offer content in both Spanish and English for learners and curious readers.
- Serve as a base for educational resources, presentations, and personal projects.
...
images/ → Mapas, esquemas, ilustraciones (opcional)
content/es/ contiene los textos en español.
content/en/ contains the texts in English.
images/ puede almacenar mapas, diagramas u otras imágenes.
```
